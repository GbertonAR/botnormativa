...
def buscar_registro():
    if request.method == 'POST':
        ...
        return redirect(url_for('canje.ver_registro', tramite_id=tramite_id))
    return render_template('buscar_registro.html')

#### Funciones para imagenes que llegan como archivo
...
#### Funciones para imagenes que llegan de la camara activa
    ...
    if document:
        ...
        try:
            ...
            if document_type == 'dorso_dni':
                ...
                ocr_text = extract_text_from_image_azure(image_bytes)
